...
public class FAQView: UIView {
  ...
  public init(frame: CGRect,title: String = "Answers for Questions", items: [FAQItem]) {
    self.items = items
...
public class FAQConfiguration {
  ...
  func defaultValue() {
    ...
    self.questionTextFont = UIFont(name: "Avenir-Book", size: 20)
    self.answerTextFont = UIFont(name: "Avenir-Book ", size: 20)
    self.titleTextColor = UIColor.black
    self.titleTextFont = UIFont(name: "Avenir-Book ", size: 20)
